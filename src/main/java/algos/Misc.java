...
public class Misc {
	...
	/**
	 * Frst map the points to their distance from the origin
	 * then sort smallest to greatest
	 ...
	 * of the differences of the coordinates. For distance from the 
	 * origin, this effectively means sqrt(x^2 + y^2)
	 * @param point [x, y]
