...
public class MiscTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			{createPointsFrom(1, 3, -2, 2), 1, createPointsFrom(-2, 2)},
	...
	public MiscTest(final int[][] points, final int k, final int[][] expected) {
		this.points = points;
		this.k = k;
	...
	public void testKClosest_mapSortLimit() {
		assertArrayEquals(expected, misc.kClosest(points, k));
	}
